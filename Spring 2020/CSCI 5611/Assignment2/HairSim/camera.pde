...
class Camera
{
  ...
  {
    if ( key == 'w' ) positiveMovement.z = 15;
    if ( key == 's' ) negativeMovement.z = -15;
    if ( key == 'a' ) negativeMovement.x = -15;
    if ( key == 'd' ) positiveMovement.x = 15;
    if ( key == 'q' ) positiveMovement.y = 15;
    if ( key == 'e' ) negativeMovement.y = -15;
